...
const buttonVariants = {
  primary:
    "bg-primary-600 hover:bg-primary-700 active:bg-primary-800 text-white focus:ring-primary-500 focus:ring-2 focus:ring-offset-2 hover:shadow-lg active:shadow-md transform hover:-translate-y-0.5 active:translate-y-0",
  secondary:
    ...
    return (
      <button
        ...
        className={cn(
          ...
          "relative overflow-hidden", // For future ripple effects
