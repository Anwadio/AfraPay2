...
const TransactionItem = ({
  ...
  return (
    <div
      className={cn(
        'flex items-center p-4 hover:bg-neutral-50 transition-colors cursor-pointer',
        className
      )}
      ...
      {Object.entries(groupedTransactions).map(([date, dayTransactions]) => (
        <div key={date}>
          {formatDateHeader(date) && (
            <div className="sticky top-0 bg-neutral-50 border-b border-neutral-200 px-4 py-2 z-10">
...
const TransactionSummary = ({
  ...
  return (
    <div className={cn('bg-white rounded-xl border border-neutral-200 p-6', className)} {...props}>
      <h3 className="text-lg font-semibold text-neutral-900 mb-4">{period} Summary</h3>
      
      <div className="grid grid-cols-3 gap-6">
        <div>
          <p className="text-sm text-neutral-600 mb-1">Money In</p>
        ...
        <div>
          <p className="text-sm text-neutral-600 mb-1">Money Out</p>
        ...
        <div>
          <p className="text-sm text-neutral-600 mb-1">Net Flow</p>
          <p className={cn(
