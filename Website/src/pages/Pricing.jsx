...
import { SCHEMA_PRICING } from "../components/seo/schemas";
...
const Pricing = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-secondary-50">
      <SEOHead
        title="Pricing Plans – Affordable Payments for Africa"
        description="Choose your AfraPay plan. Free for individuals, professional plans for businesses, enterprise for large organisations. Transparent pricing, no hidden fees."
        keywords="AfraPay pricing, payment plans Africa, fintech pricing, affordable transfers, enterprise payments"
        structuredData={SCHEMA_PRICING}
      />
      {/* Hero Section */}
      <section
            ...
            {plans.map((plan, index) => (
              <div
                ...
                className={`relative rounded-2xl border-2 p-8 ${
                  plan.popular
                    ? "bg-gradient-to-br from-primary-50 to-secondary-50 border-primary-500 shadow-xl md:scale-105"
                    : "bg-gradient-to-br from-primary-50 to-secondary-50/40 border-primary-200 shadow-lg"
                }`}
              >
                {plan.popular && (
        ...
        <Container>
          ...
          <div className="max-w-3xl mx-auto">
            {faqs.map((faq, index) => (
              <div
                key={index}
                className="mb-8 bg-gradient-to-r from-primary-50 to-secondary-50/60 rounded-lg border border-primary-100 p-6"
              >
