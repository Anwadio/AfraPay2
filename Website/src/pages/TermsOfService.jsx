...
import { CheckCircle2, Clock3, FileText, Scale } from "lucide-react";
...
const SUPPORT_EMAIL = "legal@afrapayafrica.com";
  ...
  return (
    <div className="min-h-screen bg-[#f5f7f8]">
      ...
      <div
        ...
        style={{
          backgroundImage: "url('/Carouselimages/ServiceIamge.png')",
      ...
      >
        ...
        <div className="max-w-5xl mx-auto relative z-10">
          <div className="flex items-center gap-2 text-secondary-300 text-xs font-semibold uppercase tracking-[0.2em] mb-5">
            ...
            AfraPay legal centre
          </div>
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-4">
            Terms of Service
          </h1>
          <p className="text-primary-100 max-w-2xl text-base leading-relaxed">
            The straightforward rules and responsibilities that govern your use of AfraPay services.
          </p>
      ...
      <div className="max-w-6xl mx-auto px-4 py-10 lg:py-14 lg:flex lg:gap-10">
        ...
        <main className="flex-1 min-w-0 bg-white rounded-2xl border border-neutral-200/80 p-6 md:p-10 shadow-[0_18px_50px_rgba(15,23,42,0.06)]">
          <div className="mb-10 p-5 bg-amber-50 border border-amber-200 rounded-xl text-sm text-amber-900 flex gap-3">
            <FileText className="w-5 h-5 shrink-0 text-amber-600 mt-0.5" aria-hidden="true" />
            <p>
