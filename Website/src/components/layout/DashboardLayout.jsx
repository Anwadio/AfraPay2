...
const DashboardLayout = ({
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "min-h-screen [height:100svh] bg-gradient-to-br from-primary-100 via-white to-secondary-100/60 dark:from-neutral-950 dark:via-neutral-900 dark:to-neutral-950",
