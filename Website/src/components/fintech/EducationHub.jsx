...
const EducationHubHeader = () => {
  return (
    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
      <div>
        <h1 className="text-2xl font-bold text-primary-900">Education Hub</h1>
  ...
  if (!content || content.length === 0) {
    return (
      <div className="bg-primary-100 rounded-xl p-8 text-center">
        <p className="text-primary-700">No featured content available</p>
      </div>
    );
  }
  ...
  if (!paths || paths.length === 0) {
    return (
      <div className="text-center py-8">
        <p className="text-primary-700">No learning paths available</p>
      </div>
    );
  }
  ...
  return (
    <DashboardCard className="group hover:shadow-lg transition-all duration-200">
      <div className="relative">
        {/* Image placeholder */}
        <div className="h-32 bg-gradient-to-br from-primary-100 to-secondary-100 rounded-t-lg flex items-center justify-center">
          <svg
...
const CategoryTabs = ({ categories, selectedCategory, onCategoryChange }) => {
  ...
  return (
    <div className="bg-gradient-to-r from-primary-50 to-secondary-50/30 rounded-lg border border-primary-200 p-1">
...
const ContentCard = ({ content, onClick }) => {
  ...
  const getLevelColor = (level) => {
    const colors = {
      ...
      Intermediate: "text-blue-600 bg-blue-50",
      Advanced: "text-purple-600 bg-purple-50",
      "All Levels": "text-primary-700 bg-primary-50",
    };
    return colors[level] || colors.Beginner;
  };
...
const ContentCardSkeleton = () => {
  return (
    <DashboardCard className="animate-pulse">
      <div className="h-32 bg-primary-100 rounded-t-lg"></div>
      <div className="p-4 space-y-3">
        <div className="flex items-center gap-2">
          <div className="h-5 bg-primary-100 rounded w-16"></div>
        </div>
        <div className="space-y-2">
      ...
      <div className="bg-white rounded-xl shadow-xl max-w-2xl w-full max-h-[90vh] overflow-hidden">
        ...
        <div className="p-6 space-y-6 max-h-[calc(90vh-120px)] overflow-y-auto">
          <div>
            ...
            <p className="text-primary-700">{content.description}</p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4 text-sm">
            <div>
              ...
              <p className="font-medium text-primary-900">{content.author}</p>
            </div>
            <div>
              <span className="text-primary-700">Duration:</span>
              <p className="font-medium text-primary-900">{content.duration}</p>
            </div>
            <div>
              <span className="text-primary-700">Views:</span>
              <p className="font-medium text-primary-900">
                {content.views.toLocaleString()}
              </p>
            </div>
            <div>
              <span className="text-primary-700">Published:</span>
              <p className="font-medium text-primary-900">
          ...
          {/* Tags */}
          <div>
            <span className="text-sm text-primary-700 mb-2 block">Tags:</span>
